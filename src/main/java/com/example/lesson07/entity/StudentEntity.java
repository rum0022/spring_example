...
@Builder(toBuilder = true) // setter대신 사용 , 빌더만 쓰면 처음 초기세팅만 가능하고 중간에 바꾸지못함, toBuilder = true이면 필드값 변경허용 
@Getter
@Table(name = "new_student") // db의 테이블 이름이 studententity가 아니고 student라고 알려주는것
